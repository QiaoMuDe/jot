...
| 类别 | 功能 |
|------|------|
| 🃏 **卡片式笔记** | 分页懒加载，支持多种排序、置顶、彩色标识 |
| 🏷️ **标签管理** | 多对多关联，点击筛选，6 个默认标签 + 自定义 |
| 🔍 **全文搜索** | 标题 + 内容模糊搜索，250ms 防抖 + 回车即时触发 |
| ♻️ **回收站** | 软删除可恢复，支持批量操作 + 全部清空 |
| 📤 **数据管理** | 一键导出/导入、快速备份还原、数据统计、恢复出厂设置 |
| 🎨 **6 套主题** | Default / Nord / Monokai Pro / Light / Tokyo Night / Dark |
| ⌨️ **快捷键** | `Ctrl+F` 搜索 / `Ctrl+N` 新建 / 方向键翻页 / 数字键导航 |
| 📝 **Markdown 渲染** | 只读模式支持 Markdown + 代码高亮 |
| 🔔 **通知系统** | 右上角浮动通知，4 种类型色彩区分 |
| 🚀 **快速笔记** | 启动即全屏编辑，捕捉灵感 |
