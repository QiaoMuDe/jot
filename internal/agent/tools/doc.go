...
//     ls_dir / glob / grep_file / copy_file / move_file / delete_file / mkdir_dir / run_command / run_python / transfer_file
//     这 13 个文件/命令工具封装为内层子 Agent，父层仅注册 os_agent 一个入口，内层工具构造器
//     （NewReadFile / NewWriteFile / NewEditFile / NewLsDir / NewGlob / NewGrepFile /
//     NewCopyFile / NewMoveFile / NewDeleteFile / NewMkdirDir / NewRunCommand / NewRunPython / NewTransferFile）由 buildOSSubAgent 装配。
