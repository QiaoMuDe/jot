...
│   │   │   └── tools/                      # 内置工具实现（manage_note/ask_user/plan/recall_notes/read_url/http_request/json 三件套/manage_notebook/manage_tag/manage_todo/get_stats 共 14 个）
