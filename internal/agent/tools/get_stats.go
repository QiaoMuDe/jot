...
//   - overview：数据统计概览（缺省），返回笔记/回收站/置顶/笔记本/标签/待办/密码记录/长期记忆/AI 用量/
//     数据库大小/向量索引状态等总量信息；
...
func (g *getStatsTool) Info(_ context.Context) (*schema.ToolInfo, error) {
	return &schema.ToolInfo{
		Name: "get_stats",
		Desc: "获取应用数据统计与状态概览（只读，不修改任何数据）。当用户询问'总共有多少笔记/笔记本/标签/待办/密码记录/长期记忆、写了多少篇笔记、向量索引状态、AI 使用量（会话/消息/token/耗时）、数据库大小'等总量或概览类问题时调用。通过 action 参数区分：overview=数据统计概览（缺省，包含笔记/回收站/置顶/笔记本/标签/待办/密码记录/长期记忆/AI 用量/数据库大小/向量索引状态）；month=某月每日笔记数（需提供 year 年份与 month 月份，缺省为当前年月）。边界：查看具体笔记/待办/标签/笔记本/记忆列表请用对应的 manage_note / manage_todo / manage_tag / manage_notebook / manage_memory 工具；本工具只回答总量与趋势。",
