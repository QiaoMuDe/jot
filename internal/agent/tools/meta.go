...
func BuiltinTools() []ToolMeta {
	return []ToolMeta{
		...
		{Name: "manage_todo", Label: "管理待办（创建/查看/修改/勾选/删除/清空已完成等）"},
		{Name: "manage_notebook", Label: "管理笔记本（创建/重命名/查看/删除等）"},
		{Name: "manage_tag", Label: "管理标签（创建/查看/重命名/改色/删除等）"},
		{Name: "manage_memory", Label: "管理长期记忆（保存/更新/删除/列出）", AlwaysOn: true},
		{Name: "browse_notes", Label: "浏览/阅读笔记（列出搜索或按行号/分段查看全文）"},
		{Name: "manage_note", Label: "管理笔记（创建/编辑/置顶/移动/打标签/删除等写操作）"},
