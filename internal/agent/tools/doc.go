...
//     create_plan / update_plan / read_file / write_file / ls_dir / glob / run_command）每文件一个，
...
//     NewCreatePlan / NewUpdatePlan / NewReadFile / NewWriteFile / NewLsDir / NewGlob / NewRunCommand），
