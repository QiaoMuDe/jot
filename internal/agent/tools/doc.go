...
//     manage_notebook / manage_tag / manage_memory / manage_note / get_stats / ask_user /
...
//     NewManageNotebook / NewManageTag / NewManageMemory / NewManageNote / NewGetStats / NewAskUser /
